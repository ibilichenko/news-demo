  ...
  if (data) {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.newsContainer}>
          <PageHeader
            ...
            title={data.title} />
          <AboutArticle articleCategories={data.category} published={data.published} author={data.author} />
        ...
        {/* <CommentList articleId={newsId ? newsId : ''}/> */}
      </div>
    )
  }
  else {
    return (
      <div className={styles.errorMessage}>
        ...
        <Button type="primary" size={'large'}><Link to="/news">Back to home page</Link></Button>
      </div>
    )
  }
}
